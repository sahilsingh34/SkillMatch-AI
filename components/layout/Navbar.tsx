...
export async function Navbar() {
  ...
  return (
    <header className="fixed top-0 z-[100] w-full border-b border-slate-200/50 dark:border-white/5 bg-white/60 dark:bg-background/60 backdrop-blur-lg shadow-sm">
