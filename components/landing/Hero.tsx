    ...
    return (
        <section className="relative min-h-screen flex flex-col items-center justify-center pt-28 pb-24 bg-white overflow-hidden selection:bg-violet-100">
            ...
            <div className="relative z-10 text-center max-w-5xl px-4 animate-in fade-in slide-in-from-bottom-6 duration-1000">
                ...
                {/* Top badge */}
                <div className="inline-flex items-center gap-2 px-4 py-2 mb-8 text-sm font-semibold text-violet-700 bg-violet-50 border border-violet-200 rounded-full">
                ...
                <div className="flex flex-wrap items-center justify-center gap-8 md:gap-16 pt-8 border-t border-slate-200/60">
                    <div className="text-center">
                        <div className="text-3xl md:text-4xl font-extrabold text-slate-900 tracking-tight">10K+</div>
                        <div className="text-sm text-slate-400 font-medium mt-1">Active Jobs</div>
                    </div>
                    <div className="hidden sm:block w-px h-10 bg-slate-200"></div>
                    <div className="text-center">
                        <div className="text-3xl md:text-4xl font-extrabold text-slate-900 tracking-tight">50K+</div>
                        <div className="text-sm text-slate-400 font-medium mt-1">Candidates</div>
                    </div>
                    <div className="hidden sm:block w-px h-10 bg-slate-200"></div>
                    <div className="text-center">
                        <div className="text-3xl md:text-4xl font-extrabold text-slate-900 tracking-tight">95%</div>
                        <div className="text-sm text-slate-400 font-medium mt-1">Match Accuracy</div>
                    </div>
                    <div className="hidden sm:block w-px h-10 bg-slate-200"></div>
                    <div className="text-center">
                        <div className="text-3xl md:text-4xl font-extrabold text-slate-900 tracking-tight">2K+</div>
