        ...
        <div className="flex flex-col min-h-screen bg-white">
            ...
            <section className="py-14 border-b border-slate-100 bg-white">
                <div className="container mx-auto px-4 lg:px-8 max-w-6xl">
                    ...
                    <div className="flex flex-wrap justify-center items-center gap-x-14 gap-y-8 opacity-50 grayscale hover:grayscale-0 hover:opacity-100 transition-all duration-700">
                        {/* Google */}
                        <div className="flex items-center gap-2">
                            ...
                            <span className="font-bold text-slate-700 text-base tracking-tight">Google</span>
                        </div>
                        {/* Microsoft */}
                        <div className="flex items-center gap-2">
                            ...
                            <span className="font-bold text-slate-700 text-base tracking-tight">Microsoft</span>
                        </div>
                        {/* Amazon */}
                        <div className="flex items-center gap-1.5">
                            ...
                            <span className="font-bold text-slate-700 text-base tracking-tight">Amazon</span>
                        </div>
                        {/* Apple */}
                        <div className="flex items-center gap-2">
                            <svg viewBox="0 0 24 24" className="w-4 h-4" fill="#111827"><path d="M18.71 19.5c-.83 1.24-1.71 2.45-3.05 2.47-1.34.03-1.77-.79-3.29-.79-1.53 0-2 .77-3.27.82-1.31.05-2.3-1.32-3.14-2.53C4.25 17 2.94 12.45 4.7 9.39c.87-1.52 2.43-2.48 4.12-2.51 1.28-.02 2.5.87 3.29.87.78 0 2.26-1.07 3.8-.91.65.03 2.47.26 3.64 1.98-.09.06-2.17 1.28-2.15 3.81.03 3.02 2.65 4.03 2.68 4.04-.03.07-.42 1.44-1.38 2.83z" /><path d="M13 3.5c.73-.83 1.94-1.46 2.94-1.5.13 1.17-.34 2.35-1.04 3.19-.69.85-1.83 1.51-2.95 1.42-.15-1.15.41-2.35 1.05-3.11z" /></svg>
                            <span className="font-bold text-slate-800 text-base tracking-tight">Apple</span>
                        </div>
                        {/* Meta */}
                        <div className="flex items-center gap-2">
                            ...
                            <span className="font-bold text-slate-800 text-base tracking-tight">Meta</span>
                        </div>
                        {/* Netflix */}
                        <div className="flex items-center gap-2">
                            ...
                            <span className="font-bold text-slate-800 text-base tracking-tight">Netflix</span>
                        </div>
                        {/* Spotify */}
                        <div className="flex items-center gap-2">
            ...
            {/* Features Section - Light theme cards */}
                ...
                <div className="container mx-auto px-6 max-w-6xl relative z-10">
                    ...
                    <div className="grid md:grid-cols-3 gap-6">
                        <motion.div
                            ...
                            viewport={{ once: true }}
                            className="group p-8 rounded-2xl bg-white border border-slate-100 shadow-sm hover:shadow-lg hover:border-violet-100 transition-all duration-500"
                        >
                            <div className="h-14 w-14 bg-violet-50 border border-violet-100 rounded-xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
                        ...
                        <motion.div
                            ...
                            viewport={{ once: true }}
                            className="group p-8 rounded-2xl bg-white border border-slate-100 shadow-sm hover:shadow-lg hover:border-blue-100 transition-all duration-500"
                        >
                            <div className="h-14 w-14 bg-blue-50 border border-blue-100 rounded-xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
                        ...
                        <motion.div
                            ...
                            viewport={{ once: true }}
                            className="group p-8 rounded-2xl bg-white border border-slate-100 shadow-sm hover:shadow-lg hover:border-cyan-100 transition-all duration-500"
                        >
                            <div className="h-14 w-14 bg-cyan-50 border border-cyan-100 rounded-xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
                    ...
                    >
                        ...
                        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                            <Link href="/auth/signup">
                                <Button size="lg" className="bg-gradient-to-r from-violet-600 to-blue-600 hover:from-violet-500 hover:to-blue-500 text-white rounded-xl px-12 h-14 text-base font-bold shadow-xl shadow-violet-500/20 transition-all hover:-translate-y-0.5 hover:shadow-violet-500/30 border-0">
                                    Get Started — It&apos;s Free
                                </Button>
                            </Link>
                            <Link href="/jobs">
                                <Button size="lg" variant="outline" className="bg-white border-slate-200 hover:bg-slate-50 text-slate-900 rounded-xl px-12 h-14 text-base font-bold shadow-sm transition-all hover:-translate-y-0.5">
                                    Explore Jobs
                                </Button>
                            </Link>
                        </div>
