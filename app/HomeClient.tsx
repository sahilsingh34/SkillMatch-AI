...
const liveNotifications = [
    { icon: <CheckCircle2 className="w-4 h-4 text-emerald-500" />, text: "Sarah matched with Senior Dev role", time: "Just now", color: "bg-emerald-50 dark:bg-emerald-950/40" },
    { icon: <Send className="w-4 h-4 text-blue-500" />, text: "Alex applied to Google", time: "2m ago", color: "bg-blue-50 dark:bg-blue-950/40" },
    { icon: <Bell className="w-4 h-4 text-violet-500" />, text: "Netflix posted 3 new roles", time: "5m ago", color: "bg-violet-50 dark:bg-violet-950/40" },
    { icon: <CheckCircle2 className="w-4 h-4 text-emerald-500" />, text: "James got interview at Meta", time: "8m ago", color: "bg-emerald-50 dark:bg-emerald-950/40" },
    { icon: <Send className="w-4 h-4 text-blue-500" />, text: "Emily matched with PM role", time: "12m ago", color: "bg-blue-50 dark:bg-blue-950/40" },
    { icon: <Bell className="w-4 h-4 text-amber-500" />, text: "Amazon hiring 10+ engineers", time: "15m ago", color: "bg-amber-50 dark:bg-amber-950/40" },
    { icon: <CheckCircle2 className="w-4 h-4 text-emerald-500" />, text: "David got offer from Apple", time: "20m ago", color: "bg-emerald-50 dark:bg-emerald-950/40" },
    { icon: <Send className="w-4 h-4 text-blue-500" />, text: "Rachel applied to Stripe", time: "25m ago", color: "bg-blue-50 dark:bg-blue-950/40" },
];
                            ...
                            <div className="relative rounded-2xl border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-900 p-8 overflow-hidden hover:shadow-lg transition-shadow">
                                ...
                                <div className="relative flex h-[220px] w-full items-center justify-center overflow-hidden bg-neutral-50 dark:bg-neutral-800/50 rounded-xl border border-neutral-100 dark:border-neutral-700">
                                    ...
                                    <OrbitingCircles radius={60} duration={15} iconSize={32}>
                                        ...
                                        <div className="px-2 py-1 rounded-full bg-emerald-100 dark:bg-emerald-900/50 text-emerald-700 dark:text-emerald-300 text-[10px] font-bold">Node.js</div>
                                        <div className="px-2 py-1 rounded-full bg-amber-100 dark:bg-amber-900/50 text-amber-700 dark:text-amber-300 text-[10px] font-bold">Python</div>
                                    </OrbitingCircles>
                                    <OrbitingCircles radius={100} duration={20} reverse iconSize={28}>
                                        <div className="px-2 py-1 rounded-full bg-cyan-100 dark:bg-cyan-900/50 text-cyan-700 dark:text-cyan-300 text-[10px] font-bold">AWS</div>
                                        <div className="px-2 py-1 rounded-full bg-pink-100 dark:bg-pink-900/50 text-pink-700 dark:text-pink-300 text-[10px] font-bold">Docker</div>
                                        <div className="px-2 py-1 rounded-full bg-orange-100 dark:bg-orange-900/50 text-orange-700 dark:text-orange-300 text-[10px] font-bold">SQL</div>
                                    </OrbitingCircles>
                                </div>
                            </div>
                        </BlurFade>
                                        ...
                                        {liveNotifications.map((n, i) => (
                                            <div key={i} className={`flex items-center gap-3 ${n.color} rounded-lg p-3 border border-neutral-100 dark:border-neutral-700 w-full`}>
                                                ...
                                                <div className="flex-1 min-w-0">
                                                    <p className="text-xs font-medium text-black dark:text-white truncate">{n.text}</p>
                        ...
                        <BlurFade delay={0.2}>
                            <div className="text-center">
                                <div className="text-4xl md:text-5xl font-bold text-black dark:text-white tracking-tight">
                                    <NumberTicker value={10000} className="text-black dark:text-white" />+
                                </div>
                                <div className="text-sm text-neutral-500 dark:text-neutral-400 font-medium mt-1">Active Jobs</div>
                            </div>
                        </BlurFade>
                        <BlurFade delay={0.3}>
                            <div className="text-center">
                                <div className="text-4xl md:text-5xl font-bold text-black dark:text-white tracking-tight">
                                    <NumberTicker value={50000} className="text-black dark:text-white" />+
                                </div>
                                <div className="text-sm text-neutral-500 dark:text-neutral-400 font-medium mt-1">Candidates</div>
                            </div>
                        </BlurFade>
                        <BlurFade delay={0.4}>
                            <div className="text-center">
                                <div className="text-4xl md:text-5xl font-bold text-black dark:text-white tracking-tight">
                                    <NumberTicker value={95} className="text-black dark:text-white" />%
                                </div>
                                <div className="text-sm text-neutral-500 dark:text-neutral-400 font-medium mt-1">Match Accuracy</div>
                            </div>
                        </BlurFade>
                        <BlurFade delay={0.5}>
                            <div className="text-center">
